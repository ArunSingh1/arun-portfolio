...
import { SectionWrapper } from "../hoc";
import { slideIn } from "../utils/motion";
import { FaLinkedin, FaGithub, FaMedium } from "react-icons/fa"; // Importing icons

const Contact = () => {
  const socialLinks = [
    { icon: <FaLinkedin size={30} />, url: "https://www.linkedin.com/in/arun-singh1/" },
    { icon: <FaGithub size={30} />, url: "https://github.com/ArunSingh1" }, // Replace with your GitHub URL
    { icon: <FaMedium size={30} />, url: "https://medium.com/@arunsinghmailid" } // Replace with your Medium URL
  ];
